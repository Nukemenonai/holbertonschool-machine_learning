...
def inception_network():
    ...
    conv1 = K.layers.Conv2(filters=64, kernel_size=(7, 7),
    ...
    conv2 = K.layers.Conv2(filters=64, kernel_size=(1, 1),
                           padding='same',
                           activation='relu')
    conv2 = conv2(maxpool1)

    conv3 = K.layers.Conv2(filters=192, kernel_size=(3, 3),
                           padding='same',
                           activation='relu')
    conv3 = conv3(conv2)

    maxpool2 = K.layers.MaxPooling2D((3,3), strides=(2, 2), padding='same')
    maxpool2 = maxpool(conv3)
    ...
    inception8 = inception_block(maxpool5, [256, 160, 320, 32, 128, 128])
    inception9 = inception_block(inception6, [256, 160, 320, 32, 128, 128])
