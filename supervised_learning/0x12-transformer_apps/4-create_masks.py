...
def create_masks(inputs, target):
    """
    creates all mmasks for training/validation
    ...
    combined_mask is the tf.Tensor of shape
        ...
        to pad and mask future tokens in the input received by the decoder.
    ...
    decoder_mask is the tf.Tensor padding mask of shape
        (batch_size, 1, 1, seq_len_in) used in the
        2nd attention block in the decoder.
    """
